...
public class ApiModuleQA  {
    ...
    @Provides
    public ApiServiceQA provideApiService() {
        return provideRetrofit(getBaseURL(), provideClient()).create(ApiServiceQA.class);
    }


    public String getBaseURL () {
        return  "https://albertsonsqa-bel1.cloud.infor.com:63906/m3api-rest/";
    }
